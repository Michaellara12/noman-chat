...
export default function Register() {
  return (
    <LoginLayout title="¡Crea contenido con inteligencia artificial!" illustration="/assets/illustrations/register.png" subtitle="Usa inteligencia artificial para crear artículos (blogs), descripciones de producto, meta títulos o meta descripciones para SEO y mucho más...">
